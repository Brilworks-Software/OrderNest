                ...
                <View style={styles.profileSection}>
                    ...
                    <View style={styles.badgeContainer}>
                        <View style={styles.badge}>
                            <MaterialIcons name="support-agent" size={16} color="#10b981" style={{ marginRight: 6 }} />
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.infoCard}>
                            <View style={styles.infoRow}>
                                <MaterialIcons name="store" size={20} color="#10b981" style={{ marginRight: 12, marginTop: 2 }} />
                            ...
                            <View style={styles.infoRow}>
                                <MaterialIcons name="location-on" size={20} color="#10b981" style={{ marginRight: 12, marginTop: 2 }} />
                                <View style={styles.infoContent}>
                            ...
                            {restaurant.gst_number && (
                                <>
                                    <View style={styles.divider} />
                                    <View style={styles.infoRow}>
                                        <MaterialIcons name="receipt" size={20} color="#10b981" style={{ marginRight: 12, marginTop: 2 }} />
                                        <View style={styles.infoContent}>
                            ...
                            <View style={styles.divider} />
                            <View style={styles.infoRow}>
                                <MaterialIcons name="percent" size={20} color="#10b981" style={{ marginRight: 12, marginTop: 2 }} />
                                <View style={styles.infoContent}>
                            ...
                            <View style={styles.divider} />
                            <View style={styles.infoRow}>
                                <MaterialIcons name="attach-money" size={20} color="#10b981" style={{ marginRight: 12, marginTop: 2 }} />
                                <View style={styles.infoContent}>
