...
import { useRestaurant, useUpdateRestaurant } from '@/firebase/hooks/useRestaurant';
    ...
    return (
        ...
        <Text style={styles.header}>Settings</Text>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.profileImageContainer}>
                        {userData?.photoURL ? (
                            ...
                            <View style={styles.profileImagePlaceholder}>
                                <MaterialIcons name="person" size={40} color="#104A9c" />
                            </View>
                        )}
                    </View>
                    <Text style={styles.profileName}>{userData?.name || 'Manager'}</Text>
                    <Text style={styles.profileEmail}>{currentUser?.email || ''}</Text>
                    <View style={styles.badgeContainer}>
                        <View style={styles.badge}>
                            <MaterialIcons name="badge" size={16} color="#104A9c" style={{ marginRight: 6 }} />
                ...
                {restaurant && (
                    <View style={styles.section}>
                        <View style={styles.sectionHeader}>
                            <MaterialIcons name="restaurant" size={20} color="#104A9c" style={{ marginRight: 8 }} />
                            <Text style={styles.sectionTitle}>Restaurant Information</Text>
                        </View>
                        <View style={styles.infoCard}>
                            <View style={styles.infoRow}>
                                <MaterialIcons name="store" size={20} color="#104A9c" style={{ marginRight: 12, marginTop: 2 }} />
                            ...
                            <View style={styles.infoRow}>
                                <MaterialIcons name="location-on" size={20} color="#104A9c" style={{ marginRight: 12, marginTop: 2 }} />
                                <View style={styles.infoContent}>
                            ...
                            {restaurant.gst_number && (
                                <>
                                    <View style={styles.divider} />
                                    <View style={styles.infoRow}>
                                        <MaterialIcons name="receipt" size={20} color="#104A9c" style={{ marginRight: 12, marginTop: 2 }} />
                                        <View style={styles.infoContent}>
                            ...
                            <View style={styles.divider} />
                            <View style={styles.infoRow}>
                                <MaterialIcons name="percent" size={20} color="#104A9c" style={{ marginRight: 12, marginTop: 2 }} />
                                <View style={styles.infoContent}>
                            ...
                            <View style={styles.divider} />
                            <View style={styles.infoRow}>
                                <MaterialIcons name="attach-money" size={20} color="#104A9c" style={{ marginRight: 12, marginTop: 2 }} />
                                <View style={styles.infoContent}>
                ...
                <View style={styles.section}>
                    <View style={styles.sectionHeader}>
                        <MaterialIcons name="settings" size={20} color="#104A9c" style={{ marginRight: 8 }} />
                    ...
                    >
                        <View style={styles.optionIconContainer}>
                            <MaterialIcons name="lock" size={24} color="#104A9c" />
                        </View>
                    ...
                    >
                        <View style={styles.optionIconContainer}>
                            <MaterialIcons name="edit" size={24} color="#104A9c" />
                        </View>
                        <View style={styles.optionContent}>
                            <Text style={styles.optionTitle}>Edit Restaurant Info</Text>
                            <Text style={styles.optionDescription}>Update restaurant details and settings</Text>
                        </View>
                        <MaterialIcons name="chevron-right" size={24} color="#999" />
                    </TouchableOpacity>
