...
import {
  ...
  useUpdateMenuItem,
  useCreateMenuItem,
} from '../../firebase/hooks/useMenuItem';
...
export default function MenuItems() {
  ...
  function toggleAvailability(id: string) {
    ...
    update.mutate(
      { menuItemId: id, updates: { available: !it.available } },
      {
        onSettled: () => {
        ...
        <View style={styles.info}>
          <View style={styles.headerRow}>
            <View style={styles.nameContainer}>
              <Text
                style={[styles.name, isUnavailable && styles.unavailableName]}
                numberOfLines={1}>
                {item.name}
              </Text>
              {/* {isUnavailable && (
              ...
              <TouchableOpacity
                ...
                {isToggling ? (
                  ...
                  <Switch
                    ...
                    trackColor={{ false: '#ccc', true: '#e0e7ff' }}
                    thumbColor={item.available ? '#104A9c' : '#999'}
  ...
  function handleSave(item: MenuItemPayload) {
    ...
    if (exists) {
      ...
      update.mutate({
        menuItemId: item.id,
        updates: { name, category, description, price, image_url, available },
      });
      return;
    }
        ...
        <FlatList
          ...
          ListEmptyComponent={() => (
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptySubtitle}>Tap the + button to add your first menu item</Text>
            </View>
          )}
        />
      </View>
